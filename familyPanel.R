...
#drop lots of detritus (I need to calculate impSavings myself at some point, hence the subset now)
familyPanel <-familyPanel[c('longWeight84', 'longWeight89', 'longWeight94', 'longWeight99', 'longWeight01',
                      'longWeight03', 'longWeight05', 'longWeight07', 'longWeight09', 'longWeight11',
                      'longWeight13',
                      'uniqueID',
                      'stratification',
                      'impWealthWE84', 'impWealthWE89', 'impWealthWE94','impWealthWE99','impWealthWE01',
                      'impWealthWE03','impWealthWE05','impWealthWE07','impWealthWE09','impWealthWE11',
                      'impWealthWE13',
                      'age84', 'age89','age94','age99','age01',
                      'age03','age05','age07','age09','age11',
                      'age13',
                      'famIncome84','famIncome89','famIncome94','famIncome99','famIncome01',
                      'famIncome03','famIncome05','famIncome07','famIncome09','famIncome11',
                      'famIncome13',
                      'numInFam84', 'numInFam89','numInFam94','numInFam99','numInFam01',
                      'numInFam03','numInFam05','numInFam07','numInFam09','numInFam11',
                      'numInFam13',
                      #'state84','state89','state94','state99','state01',  # for now - later add in GDP?
                      #'state03','state05','state07','state09','state11',
                      #'state13',
                      'empStatus84','empStatus89','empStatus94','empStatus99','empStatus01',
                      'empStatus03','empStatus05','empStatus07','empStatus09','empStatus11',
                      'empStatus13',
                      'highestSchoolLev84','highestSchoolLev89','highestSchoolLev94','highestSchoolLev99',
                      'highestSchoolLev01','highestSchoolLev03','highestSchoolLev05','highestSchoolLev07',
                      'highestSchoolLev09','highestSchoolLev11','highestSchoolLev13',
                      'primarySamplingUnit'
)]
...
# remove NA data
familyPanel <- na.omit(familyPanel) #removes one observation
# age - drop 999, 0
